...
new Vue({
    ...
    data: {
        ...
        postInfo: "",
        backgroundImgStyle:{
            background: 'url(https://yun.eaqul.com/yk_coupon/WebPost/images/bbg2.png)'
        },
    ...
    methods: {
            ...
            this.$http.post(webApi + '/coupon/open/get/getCouponsInfoByPlayId', obj, {
                ...
                if (res.body.type = 'success') {
                    ...
                    if (res.body.data.list != undefined) {
                        this.couponsInfo = res.body.data.list[0];
                    }
        ...
        getJssdk: function () {
            ...
            var obj = {};
            obj.url_ = targetUrl;
            obj.userId = this.couponsInfo.userId;
        ...
        toGetCoupon: function () {
            ...
            var card_id = this.couponsInfo.sid;
            var obj = {};
            obj.userId = this.couponsInfo.userId;
            obj.card_id = card_id;
