...
ZENG.msgbox.loadingAnimationPath = ZENG.msgbox.loadingAnimationPath || (webRoot +"/resources/plugins/msgbox/loading.gif");
...
ZENG.msgbox._setPosition = function(tips, timeout, topPosition) {
	...
	//var centerHeight = $(document.body).height() / 2;
	
    ZENG.dom.setStyle(tips, "top", ((document.compatMode == "BackCompat" || ZENG.userAgent.ie < 7) ? bt : 0) + ((typeof (topPosition) == "number") ? topPosition : t) + "px");
	//ZENG.dom.setStyle(tips, "top", centerHeight + "px");
